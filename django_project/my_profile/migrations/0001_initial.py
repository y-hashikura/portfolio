# Generated by Django 5.1.1 on 2024-09-26 08:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.FileField(blank=True, null=True, upload_to='icons/', verbose_name='メニューアイコン')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_text', models.CharField(blank=True, max_length=60, null=True, verbose_name='自己紹介文')),
            ],
        ),
        migrations.CreateModel(
            name='PositionModel',
